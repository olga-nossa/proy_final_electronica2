...
void setup() {
  ...
  if (config.pixel_format == PIXFORMAT_JPEG) {
    if (psramFound()) {
      ...
      config.frame_size = FRAMESIZE_UXGA; //FRAMESIZE_QQVGA FRAMESIZE_VGA
  ...
  if (config.pixel_format == PIXFORMAT_JPEG) {
    s->set_framesize(s, FRAMESIZE_UXGA); // FRAMESIZE_QVGA FRAMESIZE_VGA
  }
